...
import { Alert, Box, Button, Card, Center, SimpleGrid, Space, Text, TextInput, Title } from "@mantine/core";
            ...
            <Center h={"100%"}>
                <Card maw={"480px"}
                    ...
                    <SimpleGrid cols={1} styles={{
                        ...
                        {t("The withdrawal function will be disabled for 24 hours after you change your login password.")}
                        </Alert>
