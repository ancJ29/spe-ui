    ...
    return (
        <>
            <Flex align={"center"} gap={20} pl={5} component="div">
                ...
                <HoverCard width={200} position="top" styles={{
                    dropdown: {
                        background: "#333537"
                    }
                }}>
                    <HoverCard.Target>
                        <Flex align={"center"} gap={5} styles={{
                            root: {
                                cursor: "help"
                            }
                        }}>
            ...
            <Space mt={10} />
            <HoverCard width={280} shadow="md" position="top" styles={{
                dropdown: {
                    background: "#26282c"
                }
            }}>
                <HoverCard.Target>
                    <Box px={10}>
                        <Box pos={"relative"} className="cursor-pointer">
                            <Box bg={"#172b23"} w={`${35}%`} h={20} pos={"absolute"} left={0} top={"50%"} style={{
                                transform: "translateY(-50%)",
                                clipPath: "polygon(0 0, 100% 0, calc(100% - 5px) 100%, 0% 100%)"
                            }} />
                            <Box bg={"#35191e"} w={`${65}%`} h={20} pos={"absolute"} right={0} top={"50%"} style={{
                                transform: "translateY(-50%)",
                                clipPath: "polygon(calc(0% + 5px) 0, 100% 0, 100% 100%, 0% 100%)"
                            }} />
                            <Flex justify={"space-between"} align={"center"} pos={"relative"} h={"100%"} styles={{
                                root: {
                                    zIndex: 1
                                }
                            }}>
                                <Flex align={"center"} gap={4} h={"100%"}>
                                    <Flex align={"center"} justify={"center"} fz={10} fw={600} bd={`solid 1px #23b26b`} w={20} h={20}
                                        style={{ textAlign: "center", borderRadius: "2px" }} c={"#23b26b"}>B
                                    </Flex>
                                    <Text c={"#23b26b"} fz={12} fw={500}>{`${35}%`}</Text>
                                </Flex>
                                <Flex align={"center"} gap={4} h={"100%"}>
                                    <Text c={"#f0444b"} fz={12} fw={500}>{`${65}%`}</Text>
                                    <Flex align={"center"} justify={"center"} fz={10} fw={600} bd={`solid 1px #f0444b`} w={20} h={20}
                                        style={{ textAlign: "center", borderRadius: "2px" }} c={"#f0444b"}>S
                                    </Flex>
                                </Flex>
                            </Flex>
                        </Box>
                                    ...
                                    <div className={"table-row table-row-default"}>
                                        ...
                                        <Box className="table-cell" w={"50%"}>
                                            <Box h={"24px"} pl={5} pos={"relative"}>
                                                ...
                                                <Flex align={"center"} justify={"end"} pos={"relative"} styles={{
                                                    root: {
                                                        zIndex: 1
                                                    }
                                                }}>
