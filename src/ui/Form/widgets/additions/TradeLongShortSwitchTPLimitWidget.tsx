...
import { Box, InputLabel, SegmentedControl, SimpleGrid } from "@mantine/core";
import { WidgetProps } from "@rjsf/utils";
import { useState } from "react";

export function TradeLongShortSwitchTPLimitWidget(props: WidgetProps) {
  ...
  return (
    <>
      <Box className="space-y-20">
        ...
        <SegmentedControl fullWidth data={['Long', 'Short']} onChange={() => {
          setValue(value === "Long" ? "Short" : "Long")
          props.onChange(value === "Long" ? "Short" : "Long")
        }} defaultValue="Long" value={value} classNames={{
