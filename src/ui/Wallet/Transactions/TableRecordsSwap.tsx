...
import { Badge, Box, Flex, Image, Table, TableData, Text, Title } from "@mantine/core";
...
export function TableRecordsSwap() {
    ...
    const tableData: TableData = {
        head: ["Coin Received", "Amount Received", "Coin Paid", "Amount Paid", "Exchange Rate", "Time", "Status"],
        body: [
