...
export function TransferForm(props: FormProps) {
  return (
    <>
      <Card p={"32px"} shadow="0 0 24px 0 rgba(18,18,20,.1)" padding="lg" radius="25px" maw={"600px"} w={"100%"} mx={"auto"}>
        ...
        <AppForm
          w={"100%"}
          schema={samples.FundTransferSchema.schema}
          uiSchema={samples.FundTransferSchema.uiSchema}
          formData={{
            ...samples.FundTransferSchema.formData,
          }}
          showJsonOutput
          api="/api/transfer"
          formDataConverter={convertToTransferFormData}
          messages={{
            titleError: "Transfer Unsuccessful",
            titleSuccess: "Transfer Successful",
            msgSuccess: "The transaction was successful and your funds have been transferred."
          }}
