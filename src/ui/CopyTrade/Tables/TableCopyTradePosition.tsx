...
type PropsType = {};
export function TableCopyTradePosition(props: PropsType) {
      ...
      body: [
        ...[...Array(10)].map(() => {
          ...
          return [
            ...
            <>
              <Title order={6}>{row.master}</Title>
            </>,
            <>
              <Title order={6}>
                <NumberFormat
            ...
            <>
              ...
              <Title
                order={6}
                c={priceDisplay(Math.random() * 100).color}
              >
                (
                <NumberFormat
                  prefix={priceDisplay(Math.random() * 100).sub}
                  decimalPlaces={2}
