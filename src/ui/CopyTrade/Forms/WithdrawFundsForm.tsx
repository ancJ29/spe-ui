...
import { Box, Button, Card, Flex, Image, InputLabel, NumberInput, Select, SimpleGrid, Text } from "@mantine/core";
...
export function WithdrawFundsForm() {
  ...
  return (
    <Box className="space-y-20">
      <Text c={"error"}>
        {t("You have open positions or unsetled profit. Withdrawal unavailable for now.")}
      </Text>
      <Box>
        ...
        <Card bg="gray.2" p={"lg"}>
          <Box>
            <Flex gap={10} align={"center"} mb={"lg"}>
              <Image w={40} h={40} src={"/images/bybit/assets/btc.svg"} />
              <Text>BTCUSDT</Text>
            ...
            <SimpleGrid cols={2}>
              <Box>
                ...
                <Text fz={20}>
                  <NumberFormat value={59976.2932} decimalPlaces={2} />
                </Text>
              </Box>
              <Box>
              ...
              <Box>
                ...
                <Text fz={20}>
                  <NumberFormat value={0.942543543} decimalPlaces={3} />
                </Text>
              </Box>
              <Box>
                <Text c={"dimmed"}>{t("Unrealized Pnl(%)")}</Text>
                <Text fz={20} c={"green"}>
                  <NumberFormat prefix="+" value={2637.51} decimalPlaces={3} />
                </Text>
                <Text fz={20} c={"green"}>
                  <NumberFormat  value={22.30} decimalPlaces={2} prefix="+" suffix="%" />
                </Text>
              </Box>
            </SimpleGrid>
          </Box>
